...
/** Minimal shape the editor needs to populate the linked-step dropdown
 * and resolve the preview's {call_type}/{duration} placeholders. */
...
function normalize(raw: unknown): CallPrepConfig {
  ...
  return {
    ...
    partner_callout_enabled: Boolean(r.partner_callout_enabled),
    partner_callout_text:
      ...
      <section className="adm-call-prep-form">
        ...
        <label className="adm-field">
          ...
          <textarea
            ...
            placeholder="Short intro paragraph — you can reference {call_type}, {duration}, etc."
          />
        ...
        >
          <input
            type="checkbox"
            checked={config.partner_callout_enabled}
            onChange={(e) =>
              setConfig({
                ...config,
                partner_callout_enabled: e.target.checked,
              })
            }
          />
          <span className="adm-form-label" style={{ margin: 0 }}>
            Show partner / co-investor callout
          </span>
        </label>

        {config.partner_callout_enabled && (
          <label className="adm-field">
            ...
            <textarea
              ...
              placeholder="If you have a spouse, partner, or co-investor — bring them along."
            />
            <span className="adm-form-hint">{PLACEHOLDER_HINT}</span>
          </label>
        )}
